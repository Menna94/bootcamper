...
BootcampSchema.pre("remove", async function (next) {
  console.log(
    `Courses Are removed from bootcamp that has the id of ${this._id}`
  );
  //make sure to delete just the courses that are under this bootcamp
